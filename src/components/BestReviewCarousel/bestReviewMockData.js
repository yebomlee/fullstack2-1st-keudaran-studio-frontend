const BEST_REVIEWS = [
  {
    ...
    productId: 1,
    productName: '레고인도 탐내는 아이팟',
  },
  {
    id: 2,
    reviewimgUrl:
      'https://www.jogumanstore.com/shopimages/playwin/0050010000012.jpg?1604394671',
    text: '귀여운거 좋아하는 사람에게 추천합니다! 진짜 딱 내스탈이에여~~!!',
    rate: 4,
    userId: '크앙분식기여어',
    productImgUrl:
      'https://www.jogumanstore.com/shopimages/playwin/0050010000012.jpg?1604394671',
    productId: 1,
    productName: 'Air pod 케이스',
  },
  {
    id: 3,
    reviewimgUrl:
    ...
    userId: '지수성',
    productImgUrl:
      'https://images.unsplash.com/photo-1623393945964-8f5d573f9358?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80',
    productId: 1,
    productName: '간지 폰 케이스',
  },
  {
    id: 4,
    reviewimgUrl: 'https://i.ibb.co/kHYZBnk/Untitled.png',
    text: '공책이 이렇게 크다래도 되나요??!!',
    rate: 3,
    userId: '창욱',
    productImgUrl: 'https://i.ibb.co/kHYZBnk/Untitled.png',
    productId: 1,
    productName: '크다란 공책',
  },
  {
    ...
    productId: 1,
    productName: '마음을 담는 다이어리',
  },
  {
    id: 6,
    reviewimgUrl:
      'https://www.jogumanstore.com/shopimages/playwin/0050010000012.jpg?1604394671',
    text: '정신을 차리니 통장잔고는 없었습니다...',
    rate: 4,
    userId: 'k-cool',
    productImgUrl:
      'https://www.jogumanstore.com/shopimages/playwin/0050010000012.jpg?1604394671',
  ...
  },
  {
    ...
    text: '이 엽서는 1876년 영국으로 부터 시작하여 마이클 조엘의 증조 할머니인 엘리자베스 엘리스가 즐겨마시던 영국식 전통찻집에서 유래하였으며...',
    rate: 5,
    userId: 'k-cool',
    productImgUrl:
